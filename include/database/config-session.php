...
class SessionManager {
    ...
    public static $session_var_firstname = "oturum-ad";
    public static $session_var_lastname = "oturum-soyad";
    ...
    public static $session_var_language_name = "oturum-dil-isim";
    public static $session_var_language_short = "oturum-dil-kisaltma";
    ...
    public function save(int $id = null) {
        ...
        switch($id != null || $id > 0) {
            case 0: // oturum id yok
                ...
                SessionManager::set(SessionManager::$session_var_firstname, null);
                SessionManager::set(SessionManager::$session_var_lastname, null);
                SessionManager::set(SessionManager::$session_var_rank, null);
                SessionManager::set(SessionManager::$session_var_language, 2);
                SessionManager::set(SessionManager::$session_var_customization_mod, 0);
            ...
            case 1: // oturum id var
                ...
                while($fetchGetSessionData = $resultGetSessionData->fetch_assoc()) {
                    ...
                    SessionManager::set(SessionManager::$session_var_username, $fetchGetSessionData[ConfigTable::$column_table_a_1] == null ? "n/a" : $fetchGetSessionData[ConfigTable::$column_table_a_1]);
                    SessionManager::set(SessionManager::$session_var_password, $fetchGetSessionData[ConfigTable::$column_table_a_2] == null ? "n/a" : $fetchGetSessionData[ConfigTable::$column_table_a_2]);
                    SessionManager::set(SessionManager::$session_var_email, $fetchGetSessionData[ConfigTable::$column_table_a_3] == null ? "n/a" : $fetchGetSessionData[ConfigTable::$column_table_a_3]);
                    SessionManager::set(SessionManager::$session_var_firstname, $fetchGetSessionData[ConfigTable::$column_table_a_4] == null ? "n/a" : $fetchGetSessionData[ConfigTable::$column_table_a_4]);
                    SessionManager::set(SessionManager::$session_var_lastname, $fetchGetSessionData[ConfigTable::$column_table_a_5] == null ? "n/a" : $fetchGetSessionData[ConfigTable::$column_table_a_5]);
                    ...
                    SessionManager::set(SessionManager::$session_var_customization_mod, $fetchGetSessionData[ConfigTable::$column_table_a_9] == null ? 0 : ($fetchGetSessionData[ConfigTable::$column_table_a_9]));
        ...
        /////////////////////////////////////////
        // oturuma ait dil bilgilerini saklamak için dizi
        $array_session_language_data = [];

        // Oturum dil adını ve kısaltmasını al
        $sqlGetSessionLanguageData = "SELECT * FROM " .ConfigTable::$table_e
        ." WHERE " .ConfigTable::$column_table_e_0 ." = ?";

        // dil bilgisi getirme sorgu bağlantısı
        $stmtGetSessionLanguageData = $this->databaseConnection->prepare($sqlGetSessionLanguageData);

        // oturuma ait dil numarasını geçici olarak tutma
        $tempSessionLanguageNum = SessionManager::get(SessionManager::$session_var_language);

        // dil bilgisi parameetreleri
        $stmtGetSessionLanguageData->bind_param("i", $tempSessionLanguageNum);

        // dil sorgusunu çalıştırma
        $stmtGetSessionLanguageData->execute();

        // dil sorgu sonucunu alma
        $resultGetSessionLanguageData = $stmtGetSessionLanguageData->get_result();

        // dil bilgisini fetch etme ve verileri diziye kaydetme

        while($fetchGetSessionLanguageData = $resultGetSessionLanguageData->fetch_assoc()) {
            $array_session_language_data[] = $fetchGetSessionLanguageData;
        }

        // dil bilgilerini almak ve oturuma aktarmak
        SessionManager::set(SessionManager::$session_var_language_name, $array_session_language_data[0][ConfigTable::$column_table_e_1]);
        SessionManager::set(SessionManager::$session_var_language_short, $array_session_language_data[0][ConfigTable::$column_table_e_2]);
        /////////////////////////////////////////

        // İşlem başarılı
        return ($id != null || $id > 0) == true ? (true) : (false);
    }
}
?>